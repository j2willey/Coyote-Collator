...
const fieldConfigs = [{"id":"Teamwork","label":"Teamwork","type":"number","audience":"judge","kind":"points"},{"id":"finder_name","label":"Finder Name","type":"text","kind":"entryname","audience":"judge","sortOrder":15},{"id":"finds","label":"finds","type":"number","audience":"judge","kind":"points"}];
